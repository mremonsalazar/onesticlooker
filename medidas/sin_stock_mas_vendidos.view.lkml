# The name of this view in Looker is "Sin Stock Mas Vendidos"
view: sin_stock_mas_vendidos {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `gke-for-ops.analytics_353816733.sin_stock_mas_vendidos` ;;
