# The name of this view in Looker is "Ads Account Non Click Stats 3189496491"
view: ads_account_non_click_stats_3189496491 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `gke-for-ops.alehop_ads.ads_AccountNonClickStats_3189496491`
    ;;
  ...
  dimension: non_click_stats_segments_year {
    type: number
