...
explore: events_20230622 {
  hidden: yes

  join: events_20230622__items {
    view_label: "Events 20230622: Items"
    sql: LEFT JOIN UNNEST(${events_20230622.items}) as events_20230622__items ;;
    relationship: one_to_many
  }

  join: events_20230622__event_params {
    view_label: "Events 20230622: Event Params"
    sql: LEFT JOIN UNNEST(${events_20230622.event_params}) as events_20230622__event_params ;;
    relationship: one_to_many
  }

  join: events_20230622__user_properties {
    view_label: "Events 20230622: User Properties"
    sql: LEFT JOIN UNNEST(${events_20230622.user_properties}) as events_20230622__user_properties ;;
    relationship: one_to_many
  }
}

# The name of this view in Looker is "Events 20230622"
view: events_20230622 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `gke-for-ops.analytics_353816733.events_20230622`
    ;;
...
# The name of this view in Looker is "Events 20230622 Items"
view: events_20230622__items {
  ...
  dimension: events_20230622__items {
    type: string
    hidden: yes
    sql: events_20230622__items ;;
  }
...
# The name of this view in Looker is "Events 20230622 Event Params"
view: events_20230622__event_params {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  dimension: events_20230622__event_params {
    type: string
    hidden: yes
    sql: events_20230622__event_params ;;
  }
...
# The name of this view in Looker is "Events 20230622 User Properties"
view: events_20230622__user_properties {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  dimension: events_20230622__user_properties {
    type: string
    hidden: yes
    sql: events_20230622__user_properties ;;
  }
