...
explore: events_20230625 {
  ...
  join: events_20230625__items {
    view_label: "Events 20230625: Items"
    sql: LEFT JOIN UNNEST(${events_20230625.items}) as events_20230625__items ;;
    relationship: one_to_many
  }

  join: events_20230625__event_params {
    view_label: "Events 20230625: Event Params"
    sql: LEFT JOIN UNNEST(${events_20230625.event_params}) as events_20230625__event_params ;;
    relationship: one_to_many
  }

  join: events_20230625__user_properties {
    view_label: "Events 20230625: User Properties"
    sql: LEFT JOIN UNNEST(${events_20230625.user_properties}) as events_20230625__user_properties ;;
    relationship: one_to_many
  }
}

# The name of this view in Looker is "Events 20230625"
...
# The name of this view in Looker is "Events 20230625 Items"
view: events_20230625__items {
  ...
  dimension: events_20230625__items {
    type: string
    hidden: yes
    sql: events_20230625__items ;;
  }
...
# The name of this view in Looker is "Events 20230625 Event Params"
view: events_20230625__event_params {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  dimension: events_20230625__event_params {
    type: string
    hidden: yes
    sql: events_20230625__event_params ;;
  }
...
# The name of this view in Looker is "Events 20230625 User Properties"
view: events_20230625__user_properties {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  dimension: events_20230625__user_properties {
    type: string
    hidden: yes
    sql: events_20230625__user_properties ;;
  }
